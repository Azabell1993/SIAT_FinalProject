...
export default {
  ...
  mounted () {
    ...
    if(vm.categoryLargeNameIndex) {
        axios.post('http://192.168.219.162:9292/pro/categoryData')
    ...
    /* genderSelecter */
    if(vm.genderIndex) {
        axios.post('http://192.168.219.162:9292/pro/genderInfo')
        .then(function (response) {
    ...
    /* colorSelecter */
    if(vm.colorIndex) {
        axios.post('http://192.168.219.162:9292/pro/colorInfo')
        .then(function (response) {
    ...
    /* material Selector*/
    if(vm.meterialIndex) {
      axios.post('http://192.168.219.162:9292/pro/materialInfo')
      .then(function (response) {
    ...
    /* age Selector*/
    if(vm.ageIndex) {
        axios.post('http://192.168.219.162:9292/pro/ageInfo')
        .then(function (response) {
    ...
    if(vm.meterialIndex) {
        axios.post('http://192.168.219.162:9292/pro/priceRangeInfo')
        .then(function (response) {
    ...
    /* seasonName Selector*/
    if(vm.seasonIndex) {
        axios.post('http://192.168.219.162:9292/pro/seasonInfo')
        .then(function (response) {
  ...
  methods: {
    ...
    productAddSpace() {
      ...
      if(!ve.product.proName) {
        ...
        alert("전송이 완료 되었습니다!");
        axios.post('http://192.168.219.162:9292/pro/proAdd', {
          ...
          if(datatest.data.data !== true) {
            ...
            console.log('picture test')
              ...
              axios.post('http://192.168.219.162:9292/pro/imageUpload', formData, {
                headers: {
